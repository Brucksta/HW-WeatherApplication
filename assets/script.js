...
const searchWeather = (event) => {
  ...
  .then(function (data) {
    ...
    document.querySelector('#emoji1').setAttribute('src', `http://openweathermap.org/img/wn/${data.list[10].weather[0].icon}@2x.png`);
    ...
    document.querySelector('#emoji2').setAttribute('src', `http://openweathermap.org/img/wn/${data.list[18].weather[0].icon}@2x.png`);
    ...
    document.querySelector('#emoji3').setAttribute('src', `http://openweathermap.org/img/wn/${data.list[26].weather[0].icon}@2x.png`);
    ...
    document.querySelector('#emoji4').setAttribute('src', `http://openweathermap.org/img/wn/${data.list[34].weather[0].icon}@2x.png`);
